  ...
  [:footer
   ...
   [:div
    ...
    [:div
     ...
     [:a
      {:href "#!", :class "mr-6 text-neutral-600 dark:text-neutral-200"}
      [:svg
     ...
     [:a
      {:href "#!", :class "text-neutral-600 dark:text-neutral-200"}
      [:svg
       {:xmlns "http://www.w3.org/2000/svg",
        :class "h-4 w-4",
        :fill "currentColor",
   ...
   [:div
    ...
    [:div
     {:class "grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4"}
     (comment "TW elements section")
     [:div
      {:class ""}
      [:h6
       {:class
   ...
   [:div
    {:class "bg-neutral-200 p-6 text-center dark:bg-neutral-700"}
    [:span "© 2023 Copyright:"]
    [:a
